...
- **No Mind-Ascribing Words (Без слів про розум системи):** Copy and naming never grant the system a mind. Out: "assistant," "smart/intelligent," "analyses," "hints," "suggests," "recommends," "proposes a diagnosis," "thinks." In: "enter," "select from the list," "by rule," "required field," "template," "completeness check." A decision is always phrased as the human's action, never the system's (*The Dumb Tool*, `PRINCIPLES.md`).
