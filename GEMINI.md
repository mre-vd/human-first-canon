...
- **Friction is the Mirror, never the Gate (Тертя — це Дзеркало, а не Ворота):** Every safeguard, checkpoint, or fuse exists to *show* the operator the consequences of a path — fatigue, debt, entropy, saturation — never to halt, defer, or override the operator's choice. The system may slow down to reflect; it may never stop to forbid. The operator can always proceed with full awareness. **Will belongs to the human.**
