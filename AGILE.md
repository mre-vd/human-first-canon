# AGILE.md — Agile Delivery & Scrum Standards

Agile delivery is a sovereign domain — the flow by which analyzed work (`ANALYSIS.md`) becomes shipped value, in small, inspected steps. Read this for Scrum/Kanban roles, events, artifacts, and flow. The frame: process serves the people and the work, never the reverse.
