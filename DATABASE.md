# DATABASE.md — Database Standards (SQL & NoSQL)

Data is a sovereign domain — kept separate from the engineering canon (`CLAUDE.md`) because data modeling, storage, and integrity are a distinct discipline. Read this for any schema, query, or data-modeling work.
